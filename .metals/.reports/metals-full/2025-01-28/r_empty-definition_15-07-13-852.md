...
class Szef extends Actor with ActorLogging {
  ...
  def przyjmowanieOdpowiedzi(
    ...
    bazaDanychOdpowiedzi: List[(ActorRef, Int)],
    licznik: Int
    ): Receive = {
      case PoprawnieOdp(odp) =>
        // Dodanie nowych odpowiedzi do bazy danych
        ...
        // Sprawdzenie, czy odpowiedzi zostały zebrane od wszystkich pracowników
        if (licznik + 1 == pierwszaGrupa.size + drugaGrupa.size) {
          log.info(s"Baza danych odpowiedzi: $updatedBazaDanychOdpowiedzi")

          // Agregacja odpowiedzi dla kandydatów
          ...
          // Wyłonienie najlepszych kandydatów z obu grup
          ...
          // Kontynuowanie przyjmowania odpowiedzi
